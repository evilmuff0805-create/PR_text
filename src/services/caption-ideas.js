...
export const CAPTION_IDEA_MODES = Object.freeze({
  entertainment: {
    label: '예능',
    direction: '짧고 재치 있는 방송 자막 리듬으로 표현하세요. 장면의 재미를 살리되 인물 비하나 조롱은 피하세요.',
  },
  situation: {
    label: '상황',
    direction: '장면에서 확인되는 사실만 간결하게 요약하세요. 인물의 의도나 보이지 않는 사실을 추측하지 마세요.',
  },
  emotion: {
    label: '감성',
...
3. 입력에서 알 수 없는 사실, 인물 관계, 감정, 의도를 만들어내지 마세요.
