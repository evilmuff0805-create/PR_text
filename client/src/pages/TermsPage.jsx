      ...
      <div className="document-layout">
        ...
        <article className="document-content">
          ...
          <section className="document-section" id="terms-service" aria-labelledby="terms-service-title">
            ...
            <p>
              본 서비스는 음성 파일을 텍스트 및 자막으로 변환하고, 입력한 장면이나 대사를 바탕으로 짧은 자막
              아이디어를 제안하는 서비스입니다.
            ...
            <p>
              ...
              사용합니다. 새 묶음의 첫 생성이 성공한 시점에 1분이 차감되고 이후 4회가 남습니다. 생성에 실패한
              요청은 횟수와 변환 시간을 차감하지 않습니다.
            </p>
            <p>
              묶음을 시작한 뒤 사용하지 않은 생성 횟수는 변환 시간으로 되돌리거나 현금으로 환산하지 않습니다.
              다만 관계 법령 또는 회사의 귀책사유에 따라 별도 처리가 필요한 경우에는 해당 기준을 우선 적용합니다.
            </p>
          </section>
          ...
          <section className="document-section" id="terms-withdrawal" aria-labelledby="terms-withdrawal-title">
            ...
            <p>
              ...
              없습니다. 남아 있는 자막 아이디어 생성 횟수도 회원 탈퇴와 동시에 소멸합니다. 결제한 변환 시간이
              남아 있거나 결제·환불 처리가 진행 중인 경우에는 환불 가능 여부와
            ...
            <p>
              신규 가입 무료 10분은 동일 로그인 계정에 최초 1회만 지급됩니다. 회원 탈퇴 후 같은 로그인
              계정으로 다시 가입할 수 있지만 신규 무료 10분은 다시 지급되지 않습니다.
            </p>
          </section>
