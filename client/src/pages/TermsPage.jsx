    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: '20px' }}>
        ...
        <ul style={{ color: 'var(--text-secondary)', lineHeight: 1.9, paddingLeft: '20px', marginTop: '12px' }}>
          ...
          <li>
            <strong style={{ color: 'var(--text-primary)' }}>정기결제(구독) 회원</strong> — 서비스 이용 후
            환불은 이용한 일수를 제외하고 일할 계산으로 처리됩니다. 월 기준은 30일이며, 월 이용료를 30으로
            나눈 금액에 잔여 일수를 곱하여 환불합니다. (결제 시점으로부터 24시간 이후 ~ 15일까지 적용)
          </li>
          <li>
          ...
          <li>
            환불 신청은 고객센터(이메일)를 통해 접수해 주시며, 잔여 환불 금액 기준은 정기결제 금액으로
            계산 후 진행됩니다.
          </li>
        </ul>
      </div>
