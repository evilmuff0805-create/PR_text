...
export default function GuidePage() {
  return (
    <div className="info-page">
      ...
      <p><a href="#guide-answers">자동 자막 질문과 답변 바로가기</a></p>
      ...
      <section id="guide-answers" className="support-faq" style={{ scrollMarginTop: 90 }} aria-labelledby="guide-answers-title">
        ...
        <div className="support-faq__list">
          {[
            ...
            ['한국어 외의 음성은 자동으로 번역되나요?', '자막 변환 단계에서는 원본 음성의 언어를 자동 감지하거나 한국어·영어·일본어·중국어를 직접 선택해 원문 자막을 만듭니다. 한국어 자막은 완료 화면에서 영어 번역 만들기를 별도로 사용해 번역 TXT로 받을 수 있습니다.'],
